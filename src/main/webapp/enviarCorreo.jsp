...
<html>
    ...
    <body>
        ...
        <div class="form">
            <form action="CorreoServlet" method="GET" id="enviarC">
                NOMBRE: <input class="enjoy-input" type="text" name="nombre"><br><br>
                CORREO: <input class="enjoy-input" type="text" name="correo"><br><br>
                CONTRASEÑA: <input class="enjoy-input" type="text" name="password"><br><br>
                DESTINATARIO: <input class="enjoy-input" type="text" name="destinatario"><br><br>
                ASUNTO: <input class="enjoy-input" type="text" name="asunto"><br><br>
                MENSAJE: <textarea class="enjoy-input" name="mensaje" form="enviarC"></textarea><br><br>
            </form>
        </div><br><br>
        <div class="editar">
